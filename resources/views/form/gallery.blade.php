	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					<div class="x_title">
						<h2>View Data<small>Gallery</small></h2>
						<div class="clearfix"></div>
					</div>
					<div class="x_content">
						<div class="row">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Form Input<small> Data Gallery</small></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form method="post" action="{{route('saveInputDataGallery')}}" enctype="multipart/form-data">
				{!! csrf_field() !!}
							...
							<div class="x_panel">
								<div class="x_content">
									...
									<div class="item form-group">
										<label class="col-form-label col-md-4 col-sm-4 label-align" for="first-name">Project Name <span class="required">*</span></label>
										<div class="col-md-8 col-sm-8 ">
											<input type="text" id="first-name" required="required" class="form-control" name="filenameImage">
										</div>
									</div>
									<div class="item form-group">
										<label class="col-form-label col-md-4 col-sm-4 label-align" for="first-name">Category Project  <span class="required">*</span></label>
										<div class="col-md-8 col-sm-8 ">
											<input type="text" id="first-name" required="required" class="form-control" name="category_project">
										</div>
									</div>
									<div class="item form-group">
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form method="post" action="{{route('updateDataGallery')}}" enctype="multipart/form-data">
				{!! csrf_field() !!}
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_content">
									...
									<div class="item form-group">
										<label class="col-form-label col-md-4 col-sm-4 label-align" for="first-name">Category Project <span class="required">*</span></label>
										<div class="col-md-8 col-sm-8">
											<input type="text" id="category_project" required="required" class="form-control" name="category_project">
										</div>
									</div>
									<div class="item form-group">
										<label class="col-form-label col-md-4 col-sm-4 label-align" for="last-name">Images <span class="required">*</span></label>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function bindingData(idData){
			$.ajax({
				url: "{{url('/')}}/getDataEditGallery/"+idData,
				success: function(data){
					console.log(data[0].filename);
					$('#filenameImage').val(data[0].filename);
					$('#category_project').val(data[0].category_project);
		...
		$(document).on("click", ".deleteData", function() {
	        ...
	        $(".corfmDelete").attr("href", "{{url('/')}}/deleteDataGallery/" + delete_id);
	    });
	});
</script>