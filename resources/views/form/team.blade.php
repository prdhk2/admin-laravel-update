	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					<div class="x_title">
						<h2>View Data<small>Team</small></h2>
						<div class="clearfix"></div>
					</div>
					<div class="x_content">
						<div class="row">
							<div class="col-sm-12">
								<div class="card-box table-responsive">
									<table id="datatable" class="table table-striped table-bordered dataSlider" style="width:100%">
										...
										<tbody>
											@php $no = 1; @endphp
											@foreach($dataOurTeam as $key => $val)
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Form Input<small> Data Team</small></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form method="post" action="{{route('saveDataTeam')}}" enctype="multipart/form-data">
				{!! csrf_field() !!}
							...
							<div class="x_panel">
								<div class="x_content">
									...
									<div class="item form-group">
										<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Employe <span class="required">*</span></label>
									...
									<div class="item form-group">
										...
										<div class="col-md-9 col-sm-9 ">
											<input type="text" id="filenameImage" required="required" class="form-control" name="position">
										</div>
									</div>
									<div class="item form-group">
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Form Edit<small> Data Team</small></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form method="post" action="{{route('updateDataOurTeam')}}" enctype="multipart/form-data">
				{!! csrf_field() !!}
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function bindingData(idData){
			$.ajax({
				url: "{{url('/')}}/getDataEditOurTeam/"+idData,
		...
		$(document).on("click", ".deleteData", function() {
	        ...
	        $(".corfmDelete").attr("href", "{{url('/')}}/deleteDataTeam/" + delete_id);
	    });
